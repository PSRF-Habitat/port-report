...
Let's try first copying everything from last year, and just adding a 5th color to the gradient and the new data to the csv... This first segment is for the bulb count graph
...
correct_order <- c("Magnolia", "Elliott Bay Marina Breakwater", "Centennial Park", 
