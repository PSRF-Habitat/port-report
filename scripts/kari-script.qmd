...
```{r}
gs4_auth()
index_data_file <- drive_download(as_id("1fQA96tL4XNMcVX8IsmIT5CPsHC8tIamu"),
...
str(pH) #check structure and confirm date is character
pH$Date <- as.Date(pH$Date,format = "%m/%d/%Y")
str(pH)
...
#pH daily average surface and bottom
#surface
#bottom
